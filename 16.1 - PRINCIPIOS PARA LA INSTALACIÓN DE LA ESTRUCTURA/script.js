...
var data = {
    ...
    tarjetas: [
        {
            text: "Posicionamiento Estratégico​",
            icon: "imagen/item01.png",
            src: "audio/audio01.mp3",
            image: "imagen/img01.jpg",
            narracion: "Nuestra primera consideración es colocar la estructura lo más cercana posible a la superficie rocosa.​"
        },
        {
            text: "Rigidez Sólida​",
            icon: "imagen/item02.png",
            src: "audio/audio02.mp3",
            image: "imagen/img02.jpg",
            narracion: "La estructura debe  presentar una rigidez óptima, lo que resulta en una reducción mínima de reajustes una vez instalada."
        },
        {
            text: "Enfoque en la Simplicidad​",
            icon: "imagen/item03.png",
            src: "audio/audio03.mp3",
            image: "imagen/img03.jpg",
            narracion: "Emplearemos piezas de fácil construcción, que estén estratégicamente ubicadas para que no interfieran con la ventilación."
        }
    ]
}
