...
var data = {
    title: 'Amacice Múltiple​​',
    title2: 'Amacice Múltiple​​',
    status: false,
    ...
    tarjetas: [
        {
            ...
            image: 'imagen/Amacice Múltiple.png',
            narracion: `Cuando se trata de obras de mayor envergadura, podemos realizar el amacice entre dos o más trabajadores.​`
        },
        {
            text: 'Experiencia en Amacice​​​',
            src: "audio/leccion02.mp3",
            image: 'imagen/Amacice Múltiple.png',
            narracion: `Los trabajadores involucrados deben poseer experiencia en amacice múltiple.​`
        },
        {
            text: 'Número de Supervisores​​​',
            src: "audio/leccion03.mp3",
            image: 'imagen/Rocas-que-no-pueden-ser-desprendidas.png',
            narracion: `La coordinación del amacice debe ser rigurosa; uno o más trabajadores supervisarán las acciones de quienes amacizan.`

        },
        {
            text: 'Objetivo de Supervisión​​',
            src: "audio/leccion04.mp3",
            image: 'imagen/Rocas-que-no-pueden-ser-desprendidas.png',
            narracion: `SLas personas que vigilan el amacice deberán alertarnos en caso nos expongamos a peligros como caída de rocas o nos posicionemos debajo de piedras abiertas​.`
        }
    ]
}
