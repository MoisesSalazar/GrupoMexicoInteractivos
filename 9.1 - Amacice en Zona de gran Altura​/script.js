...
var data = {
    title: 'Amacice en zona de gran altura​',
    title2: 'Amacice en zona de gran altura​',
    status: false,
    src: 'audio/leccion.mp3',
    tarjetas: [
        {
            text: 'Andamios o Plataformas​',
            src: "audio/leccion01.mp3",
            image: 'imagen/diapo-06-07.png',
            narracion: `Resulta esencial que tengamos una superficie adecuada donde podamos operar ya sea mediante andamios portátiles o plataformas estables. `
        },
        {
            text: 'Amacice Previo​​',
            src: "audio/leccion02.mp3",
            image: 'imagen/diapo-06-07.png',
            narracion: `Dichas plataformas deberán ser dispuestas en áreas completamente amacizadas, garantizando así la protección del personal.​.`
        },
        {
            text: 'Resistencia de barras​​',
            src: "audio/leccion03.mp3",
            image: 'imagen/item3.jpg',
            narracion: `Al ejercer palanca con estas barras pueden doblarse.`

        },
        {
            text: 'Selección de barra​​',
            src: "audio/leccion04.mp3",
            image: 'imagen/Amacice en Contrapozos.png',
            narracion: `Se utilizará barras de materiales ligeros como  fibra de vidrio, en excavaciones de más de 3.5 metros.​.`
        }
    ]
}
