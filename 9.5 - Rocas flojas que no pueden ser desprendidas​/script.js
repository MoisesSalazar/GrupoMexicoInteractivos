...
var data = {
    title: 'Rocas flojas que no pueden ser desprendidas​​',
    title2: 'Rocas flojas que no pueden ser desprendidas​​',
    status: false,
    src: 'audio/leccion.mp3',
    tarjetas: [
        {
            text: 'Comunicar al supervisor​​​',
            src: "audio/leccion01.mp3",
            image: 'imagen/diapo-08.png',
            narracion: `Si el volumen de roca abierta es grande y no podemos removerla, debemos comunicar al supervisor para proceder con el uso de explosivos, instalar el refuerzo adecuado o cerrar la zona de trabajo.​`
        }
    ]
}
