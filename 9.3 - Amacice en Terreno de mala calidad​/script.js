...
var data = {
    ...
    tarjetas: [
        {
            text: 'Rocas de mala calidad​​',
            src: "audio/leccion01.mp3",
            image: 'imagen/Amacice en Terreno de mala calidad.png',
            narracion: `En presencia de rocas de mala calidad, no se recomienda el uso de agua para lavar la superficie de la excavación, ya que esto agravaría las condiciones. `
        },
        {
            text: 'Refuerzo con concreto​​​​',
            src: "audio/leccion02.mp3",
            image: 'imagen/diapo02.png',
            narracion: `En presencia de rocas de mala calidad, es crucial que reforcemos la excavación de inmediato mediante la aplicación de una capa de concreto lanzado.​`
        },
        {
            text: 'Espesor de concreto​​',
            src: "audio/leccion03.mp3",
            image: 'imagen/diapo02.png',
            narracion: `La capa de concreto debería de tener un espesor mínimo de 2 pulgadas, el concreto funcionará como sostenimiento inicial, permitiendo el uso posterior de otro tipo de refuerzo.​`
