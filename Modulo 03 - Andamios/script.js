            ...
            carousel: [
                {
                    ...
                    narracion: 'Andamio sostenido o soportado: Es aquel andamio que no se mueve y puede armarse según la altura requerida.'
                },
                {
                    text: 'Andamio suspendido',
                    src: "audio/audio01-2.mp3",
                    image: 'imagen/img02.png',
                    narracion: 'Andamio suspendido: Es aquel andamio que se suspende por cables y tiene la capacidad de ser suspendido, subido o bajado. '
                },
                {
                    text: 'Andamios colgantes',
                    src: "audio/audio01-3.mp3",
                    image: 'imagen/img03.png',
                    narracion: 'Andamios colgantes: Es aquel que se sostiene y cuelga sobre anclajes desde la parte superior y no tiene la capacidad de ser movido o bajado.'
                },
                {
                    text: 'Andamio móvil',
                    src: "audio/audio01-4.mp3",
                    image: 'imagen/img04.png',
                    narracion: 'Andamio móvil: Pueden desplazarse a una nueva posición manteniendo su montaje.'
                },
            ]
        },
        {
            ...
            point: [
                {
                    x: '170',
                    y: '95',
                    audio: 'audio/audio03-1.mp3',
                },
                {
                    x: '250',
                    y: '-100',
                    audio: 'audio/audio03-2.mp3',
                },
                {
                    x: '-280',
                    y: '115',
                    audio: 'audio/audio03-3.mp3',
                },
                {
                    x: '-150',
                    y: '-10',
                    audio: 'audio/audio03-4.mp3',
                },
                {
                    x: '-295',
                    y: '-120',
                    audio: 'audio/audio03-5.mp3',
                }
            ]
        }
    ]
