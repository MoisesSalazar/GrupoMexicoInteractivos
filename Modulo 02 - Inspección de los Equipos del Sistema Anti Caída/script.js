...
var data = {
    title: 'Inspección de los Equipos del Sistema Anti Caída​',
    title2: 'Inspección de los Equipos del Sistema Anti Caída​',
    status: false,
    src: 'audio/presentacion.mp3',
    tarjetas: [
        {
            text: "Antes de cada uso se inspeccionará visualmente, en tierra firme el equipo de protección contra caídas (cinturones, líneas de anclaje, arneses, cuerdas o drizas, ganchos, conectores) ",
            src: "audio/audio01-1.mp3",
            image: "imagen/img01.jpg"
        },
        {
            text: "Es recomendable usar una lista de verificación. ",
            src: "audio/audio01-2.mp3",
            image: "imagen/img02.jpg"
        },
        {
            text: "Examinar todo el equipo para verificar que no tenga desgaste, daños o corrosión. ",
            src: "audio/audio01-3.mp3",
            image: "imagen/img03.png"
        },
        {
            text: "Verificar las cintas y correas no estén cortadas, rotas, torcidas o fragmentadas. ",
            src: "audio/audio01-4.mp3",
            image: "imagen/img04.png"
        },
        {
            text: "Revisar que no hayan daños causados por fuego, ácidos, solventes u otros corrosivos. ",
            src: "audio/audio01-5.mp3",
            image: "imagen/img05.jpg"
        },
        {
            text: "Las partes metálicas de los equipos deben estar libres de óxidos, rajaduras, bordes afilados y asperezas. ",
            src: "audio/audio01-6.mp3",
            image: "imagen/img06.jpg"
        },
        {
            text: "Los ganchos de seguridad deben cerrarse y asegurarse sin problema. ",
            src: "audio/audio01-7.mp3",
            image: "imagen/img07.png"
        },
        {
            text: "Comunicar al supervisor las condiciones del arnés y efectuar su devolución, si se encuentra algún defecto.",
            src: "audio/audio01-8.mp3",
            image: "imagen/img07.png"
        }
    ]
