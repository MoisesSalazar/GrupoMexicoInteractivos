...
var data = {
    title: 'Errores más comunes en los Trabajos en Altura',
    title2: 'Errores más comunes en los Trabajos en Altura',
    status: false,
    src: 'audio/leccion3.mp3',
    tarjetas: [
        {
            text: 'No usar el Equipo de Protección Personal (EPP) correspondiente',
            src: "audio/leccion4-tarjeta1.mp3",
            image: 'imagen/Recurso 1.png',
            narracion: 'Esto incluye no utilizar arneses, cascos, guantes, botas con punta de acero y otros equipos de seguridad diseñados para proteger al trabajador en alturas. ​'
        },
        {
            text: 'Usar Equipamiento Inadecuado',
            src: "audio/leccion4-tarjeta2.mp3",
            image: 'imagen/Recurso 2.png',
            narracion: 'Utilizar equipos que no están diseñados específicamente para trabajos en altura o que no son apropiados para la tarea en cuestión. ​'
        },
        {
            text: 'Usar Equipamiento Cuya Vida Útil Haya Caducado',
            src: "audio/leccion4-tarjeta3.mp3",
            image: 'imagen/Recurso 5.png',
            narracion: 'El equipo de seguridad, como arneses y líneas de vida, tiene una vida útil limitada. Utilizar equipos que han excedido su vida útil puede comprometer la seguridad. '
        }
    ]
}
