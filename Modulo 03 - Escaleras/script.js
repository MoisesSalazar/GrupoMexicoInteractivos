...
var data = {
    ...
    tarjetas: [
        {
            text: 'Tipos',
            src: "audio/audio01-0.mp3",
            image: 'imagen/tipo.png',
            carousel: [
                {
                    text: 'Andamio sostenido o soportado',
                    src: "audio/audio01-1.mp3",
                    image: 'imagen/img02.png',
                    narracion: 'Escalera Simple: Es una escalera portátil de un sólo tramo, compuesta de dos largueros en los que están encajados transversalmente y a distancias regulares unos travesaños que sirven de peldaños.​'
                },
                {
                    text: 'Andamio suspendido',
                    src: "audio/audio01-2.mp3",
                    image: 'imagen/img01.png',
                    narracion: 'Escalera Extensible: Es una escalera portátil compuesta por dos o más tramos, similar a una escalera simple, construida de forma que la longitud útil total de la escalera puede variar por desplazamiento relativo de un tramo sobre otro.​ '
                },
                {
                    text: 'Andamios colgantes',
                    src: "audio/audio01-3.mp3",
                    image: 'imagen/img03.png',
                    narracion: 'Escalera de tijera: Es una escalera portátil compuesta de dos escaleras simples iguales, unidas por la parte superior de los largueros mediante bisagras y un elemento de limitación de apertura: cadena o eslinga​.'
                }
            ]
        },
        {
            ...
            matriz: [
                [['c', 1], ['v'], ['c', 6], ['f', 'r'], ['c', 7], ['v'], ['v']],
                [['f', 'd'], ['v'], ['f', 'u'], ['v'], ['f', 'd'], ['v'], ['v']],
                [['c', 2], ['v'], ['c', 5], ['v'], ['c', 8], ['v'], ['c', 11]],
                [['f', 'd'], ['v'], ['f', 'u'], ['v'], ['f', 'd'], ['v'], ['f', 'u']],
                [['c', 3], ['f', 'r'], ['c', 4], ['v'], ['c', 9], ['f', 'r'], ['c', 10]],]
            ...
            point: [
                {
                    x: '25',
                    y: '-100',
                    audio: 'audio/escalera-1.mp3',
                },
                {
                    x: '-130',
                    y: '200',
                    audio: 'audio/escalera-2.mp3',
                },
                {
                    x: '-120',
                    y: '-10',
                    audio: 'audio/escalera-3.mp3',
                },
                {
                    x: '-190',
                    y: '60',
                    audio: 'audio/escalera-4.mp3',
                },
                {
                    x: '-40',
                    y: '100',
                    audio: 'audio/escalera-5.mp3',
                }
                ,
                {
                    x: '-115',
                    y: '-120',
                    audio: 'audio/escalera-6.mp3',
                }
            ]
        }
    ]
